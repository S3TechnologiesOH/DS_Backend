 ...
 */
router.get('/:webhookId', asyncHandler(webhookController.getById.bind(webhookController)));
 ...
 *         $ref: '#/components/responses/Unauthorized'
 */
router.post('/', authorize('Admin', 'Editor'), asyncHandler(webhookController.create.bind(webhookController)));
 ...
 *         $ref: '#/components/responses/NotFound'
 */
router.patch('/:webhookId', authorize('Admin', 'Editor'), asyncHandler(webhookController.update.bind(webhookController)));
 ...
 *         $ref: '#/components/responses/NotFound'
 */
router.delete('/:webhookId', authorize('Admin', 'Editor'), asyncHandler(webhookController.delete.bind(webhookController)));
 ...
 *         $ref: '#/components/responses/NotFound'
 */
router.post('/:webhookId/test', authorize('Admin', 'Editor'), asyncHandler(webhookController.test.bind(webhookController)));
 ...
 *         $ref: '#/components/responses/NotFound'
 */
router.get('/:webhookId/deliveries', asyncHandler(webhookController.getDeliveries.bind(webhookController)));
