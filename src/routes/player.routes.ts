...
router.get(
  ...
  asyncHandler(playerController.list.bind(playerController))
);
...
router.get(
  ...
  asyncHandler(playerController.getById.bind(playerController))
);
...
router.post(
  ...
  asyncHandler(playerController.create.bind(playerController))
);
...
router.patch(
  ...
  asyncHandler(playerController.update.bind(playerController))
);
...
router.delete(
  ...
  asyncHandler(playerController.delete.bind(playerController))
);
...
router.post(
  '/:playerId/heartbeat',
  validateRequest(playerHeartbeatSchema),
  asyncHandler(playerController.heartbeat.bind(playerController))
);
 ...
 */
router.post(
  '/:playerId/activation-code',
  authorize('Admin', 'SiteManager'),
  validateRequest(getPlayerByIdSchema),
  asyncHandler(playerController.generateActivationCode.bind(playerController))
);
