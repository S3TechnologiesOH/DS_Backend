...
const options = {
    definition: {
        ...
        info: {
            ...
            version: '1.0.0',
            description: 'Multi-tenant backend API for managing digital signage content across customers, sites, and players.',
            contact: {
                name: 'API Support',
            },
            license: {
        ...
        servers: [
            {
                url: `http://localhost:${environment_1.env.PORT}/api/v1`,
